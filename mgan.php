...
error_reporting(0);
ob_implicit_flush(1);
//السلام عليكم ورحمة الله وبركاتة هذا الملف من إضافات وتعديل المطور𓆩𝒛𝒂𝒊𝒎𝒂𝒇𝒍𝒂𝒎𓆪 @TTIKITT طبعا الملف انسرق مني وانتشر بكل مكان وكل شخص يقول ملفي كلهم خماطين تغيير حقوقي دليل فشلك//
$token = "7101805971:AAFSo6uzfc4lJiIskVld6JcKG5hjERYyfXg";//توكنك هنا
$tokens = "7101805971:AAFSo6uzfc4lJiIskVld6JcKG5hjERYyfXg"; //توكنك مرة اخرئ
#تعديل وتطوير𓆩𝒛𝒂𝒊𝒎𝒂𝒇𝒍𝒂𝒎𓆪 
...
### ### ###
$sudo = array("$امير","6873705092");#ايدي ادمن اخر
$idbot = "7101805971"; #ايدي البوت
$userbot = "ameir00bot"; #يوزر البوت
$userbots = "@$userbot";//لاتغير شي هون
$buy = "ameir_a"; #معرف المطور
$chi = "ameirv"; #معرف قناتك
mkdir("sudo");
mkdir("data");
